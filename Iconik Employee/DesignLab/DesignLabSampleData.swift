...
// AMB.11's job-box / NFC sample data (LabJobBox, LabSDRecord, the box, SD and
// status-count sets) was DELETED with its mockup at the phase's close
// (2026-08-01), once the operator smoked the converted screens on a device.
// The live distributions it encoded are asserted executably by
// scripts/test_jobbox_progress_rules.sh and its three siblings.
